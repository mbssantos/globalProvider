...
var _globalStore = __webpack_require__(79);
...
var GlobalProvider = function GlobalProvider(props) {
  return _react2.default.createElement(
    ...
    { store: _globalStore2.default.getStore(props.reducers) },
    props.children
  );
};
...
GlobalProvider.propTypes = {
  reducers: _propTypes2.default.object, // eslint-disable-line react/forbid-prop-types
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(28), __webpack_require__(70)(module)))
...
var GLOBAL_STORE = window.ReduxStore || (window.ReduxStore = {
  store: null,
  reducers: null
});

var createNewStore = function createNewStore() {
  GLOBAL_STORE.store = (0, _redux.createStore)((0, _redux.combineReducers)(GLOBAL_STORE.reducers), (0, _redux.applyMiddleware)(_reduxThunk2.default));
};

var updateStore = function updateStore() {
  GLOBAL_STORE.store.replaceReducer((0, _redux.combineReducers)(GLOBAL_STORE.reducers));
};
...
var GlobalStore = {
  getStore: function getStore() {
    var reducer = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
